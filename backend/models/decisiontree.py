...
from sklearn.metrics import accuracy_score, confusion_matrix, precision_score, recall_score, f1_score, roc_auc_score, ConfusionMatrixDisplay, classification_report
...
class DecisionTree:
    ...
    def __init__(self, X_train, X_test, y_train, y_test, config:dict = None):
        ...
        self.y_test = y_test
        self.model = tree.DecisionTreeClassifier(criterion = self.cfg['criterion'],
